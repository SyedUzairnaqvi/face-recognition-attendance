...
# Facenet is lighter than Facenet512 and is the production-safe model for Render Free.
# A fresh index must be built after deployment so the stored embeddings use the same model.
